    ...
    <div className={cn("flex flex-col gap-1.5", containerClassName)}>
      ...
      <div className="relative">
        <input
          ...
          id={inputId}
          className={cn(
            "w-full rounded-xl border border-border bg-white px-3.5 py-2.5 text-sm text-navy placeholder:text-muted/70 transition-colors focus:border-teal focus:outline-none focus:ring-4 focus:ring-teal/15",
            suffix ? "pr-10" : "",
            className,
          )}
          {...props}
